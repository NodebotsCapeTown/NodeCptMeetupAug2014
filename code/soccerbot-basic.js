...
board.on("ready", function() {
  ...
  console.log("Control Goetze-DevB with the arrow keys, and SPACE to stop.")

  //var left_wheel  = new five.Servo({ pin: 10, type: 'continuous' }).stop();
  var left_wheel  = new five.Servo({ pin: 11, type: 'continuous' }).stop();
  var right_wheel = new five.Servo({ pin: 12, type: 'continuous'  }).stop();
